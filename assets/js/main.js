...
document.body.onclick = function (e) {
  if (document.getElementById('navbar').classList.contains("navbar-mobile")) {
    document.body.onclick = function (e) {
      document.getElementById("ah").classList.replace("bi-x", "bi-list")
...
const phrases = [" Explore Brilliance With Us.","Witness Perfection With Us.","Embrace Distinction With Us.","Unleash Greatness With Us.","Encounter Mastery With Us.","Your Security Is Our Target"]
